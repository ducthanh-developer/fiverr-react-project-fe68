...
import {
  actDetailUserInformation,
  actFetchAddUserInformation,
  actHistoryJobsUser,
  actUploadImg,
} from "./modules/action";
...
export default function UserInformation(props) {
  ...
  const { detailUser, historyJobs } = useSelector(
    (state) => state.userListJobsReducer
  );
        ...
        <div className="row">
            ...
            <div className="">
              <div className=" card card-2">
                ...
                <ul className="flex Description ">
                  ...
                  <li className="flex-item-4 add__skill" onClick={handleClick}>
                    Add Skill
                  </li>
                  <div>
                    {isShow ? (
                        ...
                        <Typography>
                          ...
                          >
                            ...
                            <div className="row add__skill__button">
                              ...
                              <div className="col-6">
                                <button className="btn btn__cancle__skkil">
                                  Cancel
                                </button>
                              </div>
                              <div className="col-6">
                                <button
                                  type="submit"
                                  className="btn btn-success btn__add__skill"
                                >
                                  {" "}
                                  Thêm
                                </button>
                ...
                <ul className="flex Description ">
                  ...
                  <li className="flex-item-2" onClick={handleClick1}>
                    certification
                  </li>
                  <div>
                    {show ? (
                        ...
                        <Typography>
                          ...
                          >
                            ...
                            <div className="row add__skill__button">
                              ...
                              <div className="col-6">
                                <button
                                  className="btn btn-success btn__add__certification"
                                  type="submit"
                                >
                                  Add certification
                                </button>
          ...
          <div className="col-12  col-md-6 col-lg-8 user__information__right  userInformation__item2">
            <div className="card car__done__create">
              ...
              <div className="industry">What’s your industry</div>
            </div>
